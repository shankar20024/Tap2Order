    ...
    <div className="flex flex-col items-center sm:p-6 lg:p-2 md:p-2 px-6 ">
      ...
      {showConfirm && (
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-2xl z-10" onClick={closeConfirm}>
          <div className="bg-white p-6 rounded-xl shadow-2xl text-center w-64" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="text-sm text-gray-600 my-2">This will cancel all orders for this table.</p>
