...
export default function QRHeader({ username, tableNumber, apiStatus }) {
  return (
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-xs text-gray-500 font-medium uppercase tracking-wide">Restaurant</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm rounded-full px-3 py-2 border border-gray-200/50 shadow-sm">
              ...
              <span className="text-xs font-semibold text-gray-600 hidden sm:inline uppercase tracking-wide">
