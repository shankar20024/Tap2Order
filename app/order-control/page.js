        ...
        <div className="p-4 md:p-5">
          ...
          <div className="flex items-stretch gap-2">
            <input
              ...
              className="flex-1 border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 tracking-widest uppercase"
              maxLength={4}
            />
            <button
              onClick={searchOrders}
              disabled={loading}
              className="inline-flex items-center gap-2 px-4 py-2 bg-amber-600 text-white rounded-md text-sm hover:bg-amber-700 disabled:opacity-60"
            >
