...
const CACHE_KEY = 'tap2order_business_info';
const SESSION_KEY = 'tap2order_session_id';
...
export const getCachedBusinessInfo = (userId) => {
  try {
    ...
    console.error('Error reading business info cache:', error);
    return null;
  }
};
...
export const setCachedBusinessInfo = (userId, businessInfo) => {
  try {
    ...
    console.error('Error saving business info cache:', error);
    return false;
  }
};
...
export const clearBusinessInfoCache = (userId) => {
  try {
    ...
    console.error('Error clearing business info cache:', error);
    return false;
  }
};
...
export const clearAllBusinessInfoCache = () => {
  try {
    ...
    console.error('Error clearing all business info cache:', error);
    return false;
  }
};
