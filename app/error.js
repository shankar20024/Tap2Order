...
import { FaExclamationCircle, FaRedo, FaHome, FaBug } from 'react-icons/fa';
      ...
      >
          ...
          {process.env.NODE_ENV === 'development' && (
            <div className="mt-6 p-4 bg-red-50 border border-red-200 rounded-lg text-left">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-semibold text-red-700">Error Details (Development Mode)</span>
              </div>
        ...
        >
          ...
          <div className="text-sm text-gray-600 space-y-2">
            <p>• Click "Try Again" to retry the operation</p>
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
          <motion.div
            ...
            className="absolute top-1/4 left-0 text-red-200 text-2xl opacity-30"
          >
            ⚠️
          </motion.div>
          <motion.div
            ...
            className="absolute top-1/3 right-0 text-orange-200 text-3xl opacity-30"
          >
            🔧
          </motion.div>
          <motion.div
            ...
            className="absolute bottom-1/4 left-1/4 text-red-200 text-2xl opacity-30"
          >
            ❌
          </motion.div>
        </div>
