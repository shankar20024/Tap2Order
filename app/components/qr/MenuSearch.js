          ...
          <div className="flex gap-3 pb-2 min-w-max">
            ...
            <button
              ...
              className={`flex-shrink-0 px-5 py-3 rounded-xl text-sm font-semibold transition-all duration-300 
                       min-h-[44px] flex items-center justify-center whitespace-nowrap border shadow-sm hover:shadow-md transform hover:scale-105 ${
                activeCategory === 'All'
            ...
            {categories.map(category => {
              ...
              return (
                <button
                  ...
                  disabled={orderPlaced}
                >
                  {categoryEmojis[category] || '🍴'} {category.split('-').map(word => 
